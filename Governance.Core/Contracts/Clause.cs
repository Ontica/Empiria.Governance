...
namespace Empiria.Governance.Contracts {
  ...
  public class Clause : BaseObject {
    ...
    private Lazy<List<ContractRule>> rules = null;
    ...
    protected override void OnInitialize() {
      rules = new Lazy<List<ContractRule>>(() => ContractRule.GetList(this));
    ...
    public FixedList<ContractRule> Rules {
      get {
    ...
    internal RelatedProcedure AddRelatedProcedure(Procedure procedure) {
